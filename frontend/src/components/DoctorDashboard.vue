    ...
    <div class="container py-5">
            ...
            <table class="table table-striped table-hover mb-0 align-middle">
              <thead class="table-light">
                <tr class="text-uppercase small">
                  ...
                  <th class="py-3">Schedule & History</th>
                ...
                <tr v-for="(appt, index) in appointments" :key="appt.appointment_id">
                  ...
                  <td>
                    <div class="mb-2">
                      <span class="badge bg-light text-dark border">
                        <i class="far fa-clock me-1"></i> {{ appt.time }}
                      </span>
                  ...
                  <td class="text-end pe-4">
                    <div class="d-inline-flex gap-2">
                      <button class="btn btn-outline-primary" @click="openCompleteModal(appt)">
                        Update
                      </button>

                      <button class="btn btn-success text-white" @click="openCompleteModal(appt)">
                        Complete
                      </button>
      ...
      <div class="row g-4">
              ...
              <ul class="list-group list-group-flush">
                ...
                >
                  <div class="d-flex align-items-center">
                    <div
                      class="bg-light rounded-circle d-flex align-items-center justify-content-center me-3 text-success border"
                    ...
                    <div>
                      ...
                      <small class="text-muted"
                        ><i class="fas fa-envelope me-1"></i> {{ patient.email }}</small
                      >
                    </div>
                  </div>
                  <button
                ...
                <!-- Safer check for length -->
                <li
                  v-if="!assignedPatients || assignedPatients.length === 0"
        ...
        <div class="col-lg-5">
          <div class="card shadow border-0 h-100 rounded-3">
            <div
              class="card-header bg-dark text-white py-3 rounded-top-3 d-flex justify-content-between align-items-center"
            >
                ...
                <div class="col-3">
                  <div class="bg-white border rounded text-center py-2 shadow-sm">
                    ...
                    <strong class="d-block text-dark">
                      {{ day.date ? day.date.split('/')[0] + '/' + day.date.split('/')[1] : 'N/A' }}
                    </strong>
                  </div>
                </div>
                <div class="col-4">
                  ...
                  >
                    {{ day.morning ? '08-12 am' : 'Unavailable' }}
                  </button>
                </div>
                <div class="col-5">
                  <button
                  ...
                  >
                    {{ day.evening ? '04-09 pm' : 'Unavailable' }}
                  </button>
                </div>
              </div>
              <div
        ...
        <div class="modal-content border-0 shadow-lg">
          <div class="modal-header bg-primary text-white">
            <h5 class="modal-title">
              <i class="fas fa-stethoscope me-2"></i> Update Medical Record
            </h5>
            <button
          ...
          <div class="modal-body p-4">
            ...
            <form @submit.prevent="submitComplete">
              ...
              <div class="mb-3">
                ...
                <input
                  v-model="completionForm.diagnosis"
              ...
              <div class="row">
                <div class="col-md-6 mb-3">
                  ...
                  <textarea
                    v-model="completionForm.prescription"
                    class="form-control"
              ...
              <div class="d-flex justify-content-end pt-3 border-top mt-3">
                <button
                  class="btn btn-light border me-2 px-4"
                  type="button"
                  @click="hideActiveModal"
                >
                  Cancel
                ...
                <button class="btn btn-success px-4 fw-bold" type="submit">
                  <i class="fas fa-save me-2"></i> Save & Complete
                </button>
              </div>
            </form>
          </div>
            ...
            <div class="table-responsive">
              <table class="table table-striped mb-0">
                ...
                <tbody
                  ...
                  "
                >
                  <tr v-for="(visit, idx) in patientHistory.history" :key="idx">
...
export default {
  ...
  data() {
    return {
      ...
      availability: [],
      activeAppt: null,
      completionForm: { tests: '', diagnosis: '', prescription: '', notes: '' },
      patientHistory: null,
      activeModal: null,
    }
  },
  methods: {
    ...
    async fetchDashboardData() {
      ...
      this.appointments = apptData && apptData.appointments ? apptData.appointments : []

      // 2. Patients (This will now reflect changes immediately)
      const patData = await this.apiRequest('/doctor/assigned_patients')
      this.assignedPatients = patData && patData.assigned_patients ? patData.assigned_patients : []

      // 3. Availability
      const availData = await this.apiRequest('/doctor/availability')
      this.availability = availData && availData.availability ? availData.availability : []
    },

    async cancelAppointment(id) {
      if (!confirm('Are you sure you want to cancel this appointment?')) return

      // 1. Optimistic removal for instant feedback on the table
      ...
      // 3. FIX: Reload data to update "Assigned Patients" list
      if (res) {
    ...
    async submitComplete() {
      ...
      const idx = this.appointments.findIndex(
        (a) => a.appointment_id === this.activeAppt.appointment_id,
      )
      if (idx !== -1) this.appointments.splice(idx, 1)
      ...
      // 2. Backend Call
      const res = await this.apiRequest('/doctor/complete_appointment', 'POST', payload)
    ...
    async viewHistory(patientId) {
      ...
      if (data) {
        ...
        this.patientHistory = { patient_name: 'Unknown', history: [] }
      }
      this.showModal('historyModal')
    },

    toggleAvailability(index, type) {
      if (this.availability[index]) {
        this.availability[index][type] = !this.availability[index][type]
      }
    },

    async saveAvailability() {
      const res = await this.apiRequest('/doctor/availability', 'POST', {
